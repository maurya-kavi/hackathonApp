  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 text-xs text-slate-400 border-t border-slate-100 pt-3">
        <span className="flex items-center gap-1">📌 {proc.steps} steps</span>
        <span className="flex items-center gap-1">⏱ {proc.time}</span>
      </div>
    </div>
  );
}
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-purple-50 flex items-center justify-center text-2xl">{proc.icon}</div>
            <div>
          ...
          <button onClick={onClose} className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 hover:bg-purple-100 hover:text-purple-600 transition">✕</button>
        </div>
        ...
        <div className="mb-5">
          <h4 className="font-bold text-slate-700 text-sm mb-2">📂 Required Documents</h4>
        ...
        <div className="mb-5">
          <h4 className="font-bold text-slate-700 text-sm mb-2">🏷️ Tags</h4>
